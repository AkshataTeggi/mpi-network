...
// import { MapPin, Users, Calendar, Edit, ArrowLeft, FileText, ImageIcon, Settings, Trash2 } from "lucide-react"
...
//           <div>
//             <h1 className="text-2xl font-bold text-red-600">Station Details</h1>
//           </div>
//         </div>
...
//             Back
//           </Button>
//           <Button onClick={onEdit} className="flex items-center gap-2 bg-red-600 hover:bg-red-700 text-white">
...
//           <TabsTrigger value="documentation">Documentation ({station.documentations?.length || 0})</TabsTrigger>
...
//                   {station.mpiId && (
//                     <div>
//                       <h3 className="text-sm font-semibold text-gray-600 tracking-wide">MPI ID</h3>
//                       <span className="text-base font-medium text-gray-900">{station.mpiId}</span>
//                     </div>
//                   )}
//                 </div>
//               </div>
...
//                 <p className="text-muted-foreground">No documentation files available.</p>
//               ) : (
//                 <div className="space-y-4">
...
//                           <p className="text-sm text-muted-foreground">Added: {formatDate(doc.createdAt)}</p>
//                           {doc.fileUrl && (
//                             <a
//                               href={doc.fileUrl}
//                               target="_blank"
...
//                 Flowcharts
//               </CardTitle>
//               <CardDescription>Process flowcharts for this station</CardDescription>
//             </CardHeader>
//             <CardContent>
...
//                         <div className="flex items-start gap-3">
//                           <ImageIcon className="w-5 h-5 text-green-600 mt-1" />
//                           <div className="flex-1">
//                             <h4 className="font-medium">{flowchart.description}</h4>
//                             <p className="text-sm text-muted-foreground">Added: {formatDate(flowchart.createdAt)}</p>
//                           </div>
//                         </div>
//                         {flowchart.fileUrl && (
//                           <>
//                             <img
//                               src={flowchart.fileUrl || "/placeholder.svg"}
//                               alt={flowchart.description}
//                               className="w-full h-32 object-cover rounded border"
//                             />
//                             <a
//                               href={flowchart.fileUrl}
//                               target="_blank"
//                               rel="noopener noreferrer"
//                               className="text-sm text-blue-600 hover:underline"
//                             >
...
// import { Separator } from "@/components/ui/separator"
// import { Tabs, TabsContent, TabsList, TabsTrigger } from "@/components/ui/tabs"
// import { MapPin, Users, Calendar, Edit, ArrowLeft, FileText, ImageIcon, Trash2 } from "lucide-react"
// import type { Station } from "./types"
...
//             variant="outline"
//             onClick={handleDelete}
//             className="flex items-center gap-2 text-red-600 hover:text-red-700 hover:bg-red-50 border-red-200 bg-transparent"
//           >
//             <Trash2 className="w-4 h-4" />
//             Delete
//           </Button>
