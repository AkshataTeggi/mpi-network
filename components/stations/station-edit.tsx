...
//       setDocumentations(stationData.documentations || [])
...
//         // Only include new documentations and flowcharts
...
//           <h1 className="text-2xl font-bold text-red-600 mb-2">Failed to Load Station</h1>
...
//           <div>
//             <h1 className="text-3xl font-bold text-red-600">Edit Station</h1>
//           </div>
...
//                   Documentation ({documentations.length})
...
//   const isFormValid = () => {
//     return basicInfo.stationName.trim() && basicInfo.location.trim() && !stationNameError
//   }
...
//                 className={`${stationNameError ? "border-red-500 focus:border-red-500" : ""} ${
...
//         .filter((doc) => doc.fileUrl) // Only include items with fileUrl
//         .map((doc) => ({
//           description: doc.description || "",
//           fileUrl: doc.fileUrl,
//         }))
...
//         .filter((chart) => chart.fileUrl) // Only include items with fileUrl
//         .map((chart) => ({
//           description: chart.description || "",
//           fileUrl: chart.fileUrl,
//         }))

//       // Send ALL specifications (backend will sync based on name)
...
//         description: stationData.description || "",
//         operator: stationData.operator || "",
//         priority: stationData.priority !== undefined && stationData.priority !== null ? String(stationData.priority) : "",
//         notes: stationData.Note || [],
//       })
...
//           description: doc.description || "",
//           fileUrl: doc.fileUrl,
//           fileName: doc.fileName || "", // ✅ include fileName in submission
//         }))
...
//     description: chart.description || "",
//     fileUrl: chart.fileUrl,
//     fileName: chart.fileName || "", // if applicable
//   }))
...
//         Note: basicInfo.notes.filter((note) => note.trim() !== ""),
//         specificationValues: specificationValues,
//         documentations: allDocumentations, // Send ALL current documentations
//         flowcharts: allFlowcharts, // Send ALL current flowcharts
//         specifications: allSpecifications, // Send ALL current specifications
...
//   const handleAddNote = () => {
//     if (newNote.trim()) {
//       const updatedNotes = [...basicInfo.notes, newNote.trim()]
...
//     const updatedNotes = basicInfo.notes.filter((_, i) => i !== index)
//     handleFieldChange("notes", updatedNotes)
//   }

//   const handleEditNote = (index: number, newValue: string) => {
//     const updatedNotes = [...basicInfo.notes]
...
//                 onBlur={handleStationNameBlur}
//                 placeholder="Enter station name"
//                 className={`${stationNameError ? "border-red-500 focus:border-red-500" : ""} ${basicInfo.stationName && !stationNameError ? "border-green-500 focus:border-green-500" : ""
//                   }`}
//                 disabled={isLoading}
//               />
//               {stationNameError && (
...
//           {basicInfo.notes.length > 0 && (
//             <div className="space-y-2">
//               {basicInfo.notes.map((note, index) => (
