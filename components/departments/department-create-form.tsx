...
//   const [description, setDescription] = useState("")
//   const [isActive, setIsActive] = useState(true)
//   const [designations, setDesignations] = useState([{ title: "", isActive: true }])
//   const [isSubmitting, setIsSubmitting] = useState(false)
//   const [error, setError] = useState<string | null>(null)
//   const [success, setSuccess] = useState(false)
...
//     setDescription("")
//     setIsActive(true)
//     setDesignations([{ title: "", isActive: true }])
//     setError(null)
//     setSuccess(false)
//   }

//   const handleDesignationChange = (index: number, key: "title" | "isActive", value: any) => {
...
//     setDesignations([...designations, { title: "", isActive: true }])
//   }
...
//     console.log("Creating Designation with:", {
...
//       {success && (
//         <Alert className="mb-4 bg-green-50 border-green-500 text-green-700">
//           <AlertDescription>Department & Designations created successfully!</AlertDescription>
//         </Alert>
//       )}
...
//             <div
//               key={index}
//               className="flex items-center gap-4 border border-slate-200 p-4 rounded-md"
//             >
//               <Input
...
//             </div>
//           ))}
//           <Button type="button" onClick={addDesignation} disabled={isSubmitting || success}>
//             + Add Designation
//           </Button>
//         </div>
...
//               </>
//             ) : (
//               "Create Department & Designations"
//             )}
//           </Button>
//         </div>
//       </form>
...
//     { title: string; permissions: string; isActive: boolean }[]
//   >([])
...
//     setDesignations([...designations, { title: "", permissions: "", isActive: true }])
//   }
...
//           await createDesignation({
//             title: designation.title,
//             permissions: designation.permissions.split(",").map((p) => p.trim()),
//             departmentId: createdDept.id,
//             isActive: designation.isActive,
//           })
//         }
...
//                     <Input
//                       placeholder="e.g. dashboard, mpi, settings"
//                       value={designation.permissions}
//                       onChange={(e) =>
//                         handleDesignationChange(index, "permissions", e.target.value)
//                       }
//                       disabled={isSubmitting || success}
//                     />
//                   </div>
