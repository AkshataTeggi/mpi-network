...
//       const response = await fetch("http://54.177.111.218:4000/mpi/enums")
//       if (!response.ok) {
...
//             <Button
//   variant="outline"
//    onClick={() => window.open("/flowcharts/process-flowchart.pdf", "_blank")}
// >
...
//               Back
//             </Button>
//             <Button onClick={onEdit} size="sm" className="bg-red-600 hover:bg-red-700 text-white">
...
//                                       `http://54.177.111.218:4000/mpi-document/${doc.id}/download`,
//                                     )
//                                     if (!response.ok) {
...
//               <h2 className="text-xl font-semibold text-green-800">MPI Instructions</h2>
//             </div>
...
//                                                         try {
//                                                           const response = await fetch(
//                                                             `http://54.177.111.218:4000/station-mpi-documents/${doc.id}/download`,
//                                                           )
//                                                           if (!response.ok) {
//                                                             throw new Error("Download failed")
//                                                           }
...
//                                       <p className="text-sm text-orange-900">{selectedStation.description}</p>
//                                     </div>
//                                   </div>
//                                 )}
...
//               <div className="flex items-center gap-3 mb-4">
//                 <Info className="w-5 h-5 text-blue-600" />
//                 <h3 className="text-lg font-semibold text-blue-800">General Instructions</h3>
//               </div>
...
//               <h2 className="text-xl font-semibold text-orange-800">Checklist</h2>
...
//           </div>
//           <div className="flex items-center gap-2">
//             <Button variant="outline" onClick={() => window.open("/flowcharts/process-flowchart.pdf", "_blank")}>
//               <FileText className="w-4 h-4 mr-2" />
//               View Flowchart
//             </Button>
...
//                             <div
//                               key={station.id}
//                               className={`p-2 rounded text-sm cursor-pointer transition-all ${selectedStationId === station.id
//                                   ? "bg-blue-100 text-blue-900 font-medium border border-blue-200"
//                                   : "bg-white hover:bg-gray-100"
//                                 }`}
//                               onClick={() => setSelectedStationId(station.id)}
