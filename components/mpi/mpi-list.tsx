...
//         <div>
//           <h1 className="text-2xl font-bold text-red-600">MPI Management</h1>
//         </div>
...
//             <MPICard key={mpi.id} mpi={mpi} onEdit={onEdit} onView={onView} onDelete={onDelete} />
//           ))}
//         </div>
//       ) : (
//         <div className="space-y-4">
//           {filteredMPIs.map((mpi) => (
//             <MPIListItem key={mpi.id} mpi={mpi} onEdit={onEdit} onView={onView} onDelete={onDelete} />
//           ))}
//         </div>
//       )}
//     </div>
