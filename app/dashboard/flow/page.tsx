...
//           <h1 className="text-4xl font-bold text-gray-900 mb-4">Meritronics Assembly Standard Process Flow</h1>
//           <p className="text-lg text-gray-600 max-w-3xl mx-auto">
//             This page contains a process flow diagram for Meritronics Assembly. It outlines the standard steps involved
//             in the assembly process, from material kitting to shipping, and indicates which steps require data
//             collection.
//           </p>
//         </div>
...
//                 {processSteps.filter((step) => step.dataCollection).length} Data Collection Points
//               </Badge>
//             </CardTitle>
//             <CardDescription>
//               All colored steps require data collection. Data from all rework or repair operations must also be
//               collected.
//             </CardDescription>
//           </CardHeader>
//           <CardContent>
...
//                   <Badge variant="outline">{processSteps.filter((step) => step.category === "testing").length}</Badge>
//                 </div>
//               </div>
//             </CardContent>
//           </Card>
...
//                 <strong>Data Collection Requirements:</strong> All colored steps require data collection. Additionally,
//                 data from any rework or repair operations must be collected, even if the step is not specifically
//                 highlighted for data collection.
//               </p>
//             </div>
//           </CardContent>
//         </Card>
      ...
      <div className="mx-auto p-6">
        ...
        <Tabs defaultValue="process-flow" className="w-full">
          ...
          <TabsContent value="assembly-details" className="space-y-6">
            <Card>
              {/* <CardHeader>
                <CardTitle>Detailed Assembly Information</CardTitle>
                <CardDescription>Comprehensive assembly procedures and specifications</CardDescription>
              </CardHeader> */}
              <CardContent>
                <MeritonicsAssemblyPage />
              </CardContent>
